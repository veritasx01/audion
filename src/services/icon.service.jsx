...
export function addIcon({ height, width, fill, stroke, viewBox }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
...
// garabge pale icon
export function removeIcon({ height, width, fill, stroke, viewBox }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
...
// Plus inside circle icon, used for adding a song to "liked songs" collection
...
// for indicating on "your library" that a playlist is playing
export function fullSpeakerIcon({ height, width, fill, stroke, viewBox }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
...
export function bigAddToCollectionIcon({ height, width, fill, stroke }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
...
export function bigCheckmarkIcon({ height, width, fill, stroke }) {
  return (
    <svg
      role="img"
      aria-hidden="true"
